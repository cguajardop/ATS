...
if [[ ! -d /trafficcontrol/RPM ]]; then
  mkdir /trafficcontrol/RPM
fi

cp /root/rpmbuild/RPMS/x86_64/trafficserver*.rpm /trafficcontrol/RPM ||
    die "Failed to copy the ATS RPM to the RPM directory"
